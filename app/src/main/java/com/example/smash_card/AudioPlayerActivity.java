...
public class AudioPlayerActivity extends AppCompatActivity {
        ...
        pauseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mediaPlayer.isPlaying()) {
                    ...
                    Toast.makeText(AudioPlayerActivity.this, "Audio has been paused", Toast.LENGTH_SHORT).show();
                } else {
                    // this method is called when media
                    // player is not playing.
                    Toast.makeText(AudioPlayerActivity.this, "Audio has not played", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void playAudio() {
        ...
        String audioUrl = "https://www.youtube.com/embed/INk1W8OujQI";
